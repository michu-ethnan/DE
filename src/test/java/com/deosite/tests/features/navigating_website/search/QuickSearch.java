...
public class QuickSearch {
    ...
    public void allen_enters_the_first_two_keys(){
        theActorInTheSpotlight().attemptsTo(
              Enter.keyValues("bec").into(SEARCH_BAR)
        );
    }
    ...
    public  void allen_should_see_that_the_results_contain_the_keyword(){
        ...
        theActorInTheSpotlight().should(seeThat(QuickSearchProductName.nameOfAProductOnQuickSearchBoxByPosition(0), containsString("Bec")
        ));
    }
