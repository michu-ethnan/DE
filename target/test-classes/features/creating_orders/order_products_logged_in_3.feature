Feature: Order products logged in-3
  ...
  Scenario: Login and Order with courier delivery and transfer payment (changes billing address, click same shipping address checkbox)
  ...
  Scenario: Login and Order with courier delivery and paypal payment (changes billing address)
  ...
  Scenario: Login and Order with courier delivery and transfer payment (changes billing address)
  ...
  Scenario:  Login and Order with courier delivery and paypal payment (changes shipping address, changes billing address)
